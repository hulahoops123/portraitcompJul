...
<script setup>
const competitionTitle = 'Beyond the Frame'
const competitionTag = 'An Portrait Series without boundaries'

const maxCompetitors = 8

const entered = [
  { name: 'Alice Bennett', profile_pic: 'https://randomuser.me/api/portraits/women/1.jpg', user_id: 1 },
  { name: 'Brian Lee', profile_pic: 'https://randomuser.me/api/portraits/men/2.jpg', user_id: 2 },
  { name: 'Carla Moyo', profile_pic: 'https://randomuser.me/api/portraits/women/3.jpg', user_id: 3 },
  { name: 'Dev Patel', profile_pic: 'https://randomuser.me/api/portraits/men/4.jpg', user_id: 4 },
  null,
  null,
  null,
  null
...
const waiting = [
  { name: 'Eli Zhang', profile_pic: 'https://randomuser.me/api/portraits/men/5.jpg', user_id: 5 },
  { name: 'Fatima Noor', profile_pic: 'https://randomuser.me/api/portraits/women/6.jpg', user_id: 6 },
  { name: 'Gus the Dog', profile_pic: '/images/gus.jpg', user_id: 7 },
  { name: 'Hula the Queen', profile_pic: '/images/hula.jpg', user_id: 8 },
  { name: 'Ivan Reez', profile_pic: 'https://randomuser.me/api/portraits/men/7.jpg', user_id: 9 },
  { name: 'Jaya Ram', profile_pic: 'https://randomuser.me/api/portraits/women/8.jpg', user_id: 10 }
]
...
const enterCompetition = () => {
  alert('🎟️ Entered the competition!')
}
