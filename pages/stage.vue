    ...
    <div class="max-w-5xl mx-auto">
      ...
      <div class="grid grid-cols-4 gap-4 mb-8">
        <div 
          v-for="n in 8" 
          :key="n"
          class="h-28 flex flex-col items-center justify-center border rounded-lg"
          :class="easelClasses(n)"
        >
          <div v-if="getParticipantBySlot(n)">
            <img 
              :src="getParticipantBySlot(n).profile_pic" 
      ...
      <div class="bg-white rounded-lg shadow p-6 mb-8">
        ...
        <div class="flex flex-wrap gap-4">
          <div 
            v-for="participant in waitingParticipantsWithSelf"
            :key="participant.id"
